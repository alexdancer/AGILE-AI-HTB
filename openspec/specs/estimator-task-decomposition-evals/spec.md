...
## Purpose
Define behavior-level evaluation coverage for estimator handling of synthetic repo-aware markdown tasks, long/bullet-point task decomposition, and explicit manual-estimate rejection reasons.
