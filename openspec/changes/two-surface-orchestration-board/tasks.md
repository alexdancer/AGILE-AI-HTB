...
- [ ] 7.2 Run `openspec validate two-surface-orchestration-board --strict`, `openspec validate --all --strict`, `uv run pytest`, the recorded-demo E2E, and `npm run check`; record fresh final-tree evidence before completion.
