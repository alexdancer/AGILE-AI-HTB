...
Do not include API keys, portal tokens, bearer tokens, `.htb/secrets.env`, raw credential files, or private repository content in public issues. Redact secrets as `[REDACTED]`.
