...
**Relationships**: Operates on a Proposed Task Breakdown. Feeds Task Estimation and the AGILE Board on acceptance. Failed or invalid Task Breakdown Agent output routes here for retry or manual recovery.
...
**Relationships**: Rendered from a Session Artifact. Linked from the AGILE Board, Alarms, Task Breakdown Review, and Agent Review evidence.
